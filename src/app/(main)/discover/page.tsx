        ...
        <div className="relative h-full w-full bg-black overflow-hidden flex flex-col">
            {loading ? (
                ...
                <div className="relative flex-1 w-full overflow-hidden">
                    ...
                    <div className="absolute bottom-[calc(env(safe-area-inset-bottom)+104px)] left-0 right-0 px-6 z-30 flex items-center justify-between max-w-lg mx-auto w-full">
                        <button
                            onClick={() => setShowFilters(true)}
