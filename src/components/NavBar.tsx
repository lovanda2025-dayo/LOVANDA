...
export default function NavBar() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 px-6 pt-4 pb-[calc(env(safe-area-inset-bottom)+1rem)] bg-black/10 backdrop-blur-2xl border-t border-white/5">
